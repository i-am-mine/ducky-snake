...
template <> constexpr inline auto GameView::qt_create_metaobjectdata<qt_meta_tag_ZN8GameViewE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'updateScoreDisplay'
        QtMocHelpers::SlotData<void(int)>(3, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 4 },
        }}),
        // Slot 'showGameOverScreen'
...
void GameView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updateScoreDisplay((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->showGameOverScreen(); break;
        default: ;
        }
    }
}
